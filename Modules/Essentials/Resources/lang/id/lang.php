...
"essentials_module" => "Modul Catatan",
"new_message_notification" => "Anda memiliki pesan baru dari: pengirim",
"hrm" => "Data Karyawan",
"leave_type" => "Tipe Ijin",
"all_leave_types" => "Semua jenis ijin",
"max_leave_count" => "Hitungan Ijin Maks",
"add_leave_type" => "Tambahkan Tipe Ijin",
"edit_leave_type" => "Edit Jenis Ijin",
"leave" => "Ijin",
"all_leaves" => "Semua List Ijin",
"end_date" => "Tanggal Akhir",
"start_date" => "Mulai tanggal",
"reason" => "Alasan",
"add_leave" => "Tambah Ijin",
"approved" => "Disetujui",
...
"past" => "Lalu",
"now" => "Sekarang",
"new_leave_notification" => ":employee mengajukan ijin. No Referensi - <i>:ref_no </i>",
"status_change_notification" => ":admin :status ijin Anda. No Referensi - <i>:ref_no </i>",
"essentials_settings" => "Pengaturan Catatan",
...
"attendance" => "Absensi",
"all_attendance" => "Semua Absensi Kehadiran",
"add_attendance" => "Tambahkan Absensi",
...
"holiday" => "Jadwal Kerja",
"all_holidays" => "Semua Jadwal Kerja",
"add_holiday" => "Tambah Jadwal Kerja",
"edit_holiday" => "Edit Jadwal Kerja",
"payroll_for" => "Payroll For",
"total_payroll" => "Total Penggajian",
"approve_leave" => "Setujui Ijin",
"allowance_and_deduction" => "Kasbon",
"add_allowance_and_deduction" => "Tambahkan Tunjangan / Kasbon",
"amount_type" => "Jumlah Jenis",
"applicable_date" => "Tanggal Jatuh Tempo",
...
"edit_allowance_and_deduction" => "Edit Tunjangan / Kasbon",
...
"change_status" => "Merubah status",
"task_id" => "Id Tugas",
"essentials_n_hrm_settings" => "Pengaturan Catatan dan HRM",
...
"leaves" => "Berangkat" , 
"my_leaves" => "List Ijin Saya",
"holidays" => "Liburan",
"todays_attendance" => "Hari ini Kehadiran",
"already_clocked_in"=>"Sudah masuk",
"not_clocked_in"=>"Tidak masuk",
"crud_leave_type"=>"Tambah / Edit / Lihat / Hapus jenis ijin",
"crud_all_leave"=>"Tambah / Edit / Lihat / Hapus semua ijinn",
"crud_own_leave"=>"Tambahkan / Lihat ijin sendiri",
